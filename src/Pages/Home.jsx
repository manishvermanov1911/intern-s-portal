...
export default function Home() {
  ...
  return (
    <div className="w-full flex flex-col items-center mt-32">
      ...
      {isMobile ? (
        <div className="grid grid-cols-2 grid-rows-2 gap-0 w-[90vw] max-w-[400px] mx-auto mt-8 overflow-hidden rounded-3xl">
          {/* 1 */}
        ...
        <div className="relative w-full mx-auto mt-8 flex justify-center items-center">
          <div
            className={`h-full flex flex-row justify-center items-stretch rounded-3xl bg-[#FFF7E1] text-[#ff0000]`}
          >
            <div className="min-h-full px-8 py-6 lg:px-16 lg:py-12 text-center flex-col flex justify-center items-center w-40 lg:w-64">
              <div className="text-9xl font-urbanist text-center">1</div>
              <div className="text-md font-medium text-center font-bold font-urbanist">
                Create the future.
              </div>
            </div>
            <div className="min-h-full text-center flex-row flex justify-center items-stretch bg-[#FF0000]/50 text-[#FFF7E1] rounded-3xl">
              ...
              <div className="min-h-full text-center flex-row flex justify-center items-stretch bg-[#ff0000] text-[#FFF7E1] rounded-3xl">
                ...
                <div className="min-h-full px-8 py-6 lg:px-16 lg:py-12 text-center flex-col flex justify-center items-center bg-[#cc0000] text-[#FFF7E1] rounded-3xl w-40 lg:w-64">
      ...
      <p className=" text-[14px] md:text-[16px] mt-20  text-center font-instrument text-[#FFF7E1] max-w-[840px] mb-8">
        This internship portal contains information about all the projects that
        interns have worked on this summer, the events like Adobe Alchemy,
        connecting with leaders, and much more. Get a glimpse into intern life
        at Adobe!
