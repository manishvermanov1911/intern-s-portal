    ...
    const cy = cytoscape({
      ...
      elements: {
        nodes: [
          // Level 1
          {
            data: { id: "a", label: "Pentareddy", img: "pics/penta.jpg" },
            position: { x: 400, y: 50 },
          },

          // Level 2
          {
            data: { id: "y", label: "Surya", img: "pics/surya.jpg" },
            position: { x: 400, y: 150 },
          },

          // Level 3
          {
            data: { id: "f", label: "Debashish", img: "pics/deb.jpg" },
            position: { x: 400, y: 250 },
          },

          // Level 4 (spread evenly)
          {
            data: { id: "m", label: "Rayna", img: "pics/rayna.jpg" },
            position: { x: 50, y: 350 },
          },
          {
            data: { id: "n", label: "Suhani", img: "pics/suhani.jpg" },
            position: { x: 150, y: 350 },
          },
          {
            data: { id: "o", label: "Saicharan", img: "pics/sai.jpg" },
            position: { x: 250, y: 350 },
          },
          {
            data: { id: "p", label: "Shrighanesh", img: "pics/sriganesh.jpg" },
            position: { x: 350, y: 350 },
          },
          {
            data: { id: "q", label: "Manya", img: "pics/manya.jpg" },
            position: { x: 450, y: 350 },
          },
          {
            data: { id: "r", label: "Amitoj", img: "pics/amitoj.jpg" },
            position: { x: 550, y: 350 },
          },
          {
            data: { id: "s", label: "Vijaya", img: "pics/vijaya.jpg" },
            position: { x: 650, y: 350 },
          },
          {
            data: { id: "t", label: "Thanishk", img: "pics/Thanishk.jpg" },
            position: { x: 750, y: 350 },
          },
          {
            data: { id: "u", label: "Samanvi", img: "pics/samanavi.jpg" },
            position: { x: 850, y: 350 },
          },
          {
            data: { id: "v", label: "Raghav", img: "pics/raghav.jpg" },
            position: { x: 950, y: 350 },
          },
          {
            data: { id: "w", label: "Athitya", img: "pics/athitya.png" },
            position: { x: 1050, y: 350 },
          },
          {
            data: { id: "x", label: "Riya", img: "pics/riya.png" },
